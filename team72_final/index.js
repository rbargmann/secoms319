...
const Shop = () => {
    ...
    const removeFromCart = (el) => {
        ...
        hardCopy = hardCopy.filter(
            (cartItem) => cartItem.productID !== el.productID
        );
        setCart(hardCopy);
    };
                ...
                <div class="card collapse" id="cart">
                    ...
                    <div class="float-end">
                        <p class="mb-0 me-5 d-flex align-items-center">
                            ...
                            <span class="lead fw-normal" id="cartTotal">${cartTotal}</span>
                        </p>
                    </div>
                </div>
            }
                                ...
                                <div class="col-12">
                                    <button
                                        ...
                                        onClick={() => {
                                            ...
                                            // document.getElementById("validation").classList.add("collapse");
