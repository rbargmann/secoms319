  ...
  return (
    <div style={{ margin: "1em" }}>
      ...
      <div>
        ...
        />
        <button onClick={() => getOneByOneProductPrev()}>Previous</button>
      ...
      <h3>Developers:</h3>
      Autrin Hakimi, Email: ahakimi@iastate.edu |
      Rangsiumun Bargman, Email: rgbrgmnn@iastate.edu <br></br> <br></br>
      Professor: Dr. Abraham Aldaco <br></br> <br></br>
      Date: Apr. 29, 2023 <br></br> <br></br>
      This project was created for the Com S 319 course, Construction of User Interfaces. We used Mongo, Express, React, and Node.js to build a website that showcases the latest web development technologies. Our website enables users to see, create, delete, and update products from a Mongo database, demonstrating the seamless integration of front-end and back-end technologies. The end result is a modern, and responsive website.
    </div>
  );
} // App end
export default App;
